...
`,l&&(o.innerHTML+=`
    ...
    `)}}function c(a){for(var i=a.length-1;i>0;i--){var d=Math.floor(Math.random()*(i+1)),l=a[i];a[i]=a[d],a[d]=l}}const g=document.getElementById("createTestButton"),v=document.getElementById("printButton");g&&v&&g.addEventListener("click",()=>{v.removeAttribute("disabled")});export{M as a,B as b,T as c,E as g,I as p};
